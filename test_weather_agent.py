...
def show_instructions():
    ...
    print("```bash")
    print("adk run --agent weather_agent.agent.weather_agent")
    print("# Then type: What's the weather like in Tokyo today?")
    print("```")
    print("\n2. Test with a multi-day forecast query:")
    print("```bash")
    print("adk run --agent weather_agent.agent.weather_agent")
    print("# Then type: What's the weather forecast for London for the next 3 days?")
    print("```")
    print("\n3. Start a web UI for testing:")
    print("```bash")
    print("adk web --agent weather_agent.agent.weather_agent")

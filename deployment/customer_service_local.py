"""
Local deployment script for the Customer Service Agent.
"""
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description="Deploy and test the Customer Service Agent locally")
...
def main():
    ...
    if not openweathermap_api_key:
        ...
        print("The weather integration will use mock data instead of real weather data.")

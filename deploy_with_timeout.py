#!/usr/bin/env python3
"""
Script to deploy agents with a longer timeout.
"""
...
def deploy_customer_service_agent():
    """Deploys the customer service agent with a longer timeout."""
    load_dotenv()
...
def main():
    ...
    resource_name = deploy_customer_service_agent()
